...
export default class Statistics extends SmartView {
  ...
  _setCharts() {
    ...
    this._colorsCart = renderColorsChart(colorsCtx, tasks); // тег canvas отображение: диаграмма круговая
    this._daysChart = renderDaysChart(daysCtx, tasks, dateFrom, dateTo); // тег canvas отображение: диаграмма круговая
  }
}
